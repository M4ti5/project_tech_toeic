...
export default class ModifierResultat extends Component {
  constructor(props) {
    ...
    modifRes(event) {
        ...
        if(document.getElementById("modif"+this.props.idResultatToeic).className == "hidden"){document.getElementById("modif"+this.props.idResultatToeic).classList.replace("hidden","visible")}
        else{document.getElementById("modif"+this.props.idResultatToeic).classList.replace("visible", "hidden")}
    }
    ...
    render() {
      return (
        <div className="my-8">
            <td id={"modif"+this.props.idResultatToeic} className={"hidden"}>
              <div className="my-8">
